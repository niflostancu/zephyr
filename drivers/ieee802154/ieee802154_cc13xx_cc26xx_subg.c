...
static volatile rfc_CMD_PROP_RADIO_DIV_SETUP_t iee802154_cc13xx_radio_div_setup = {
...
/* Radio setup command for CC1312R / CC1352R */
static volatile rfc_CMD_PROP_RADIO_DIV_SETUP_PA_t iee802154_cc13xx_radio_div_setup = {
...
static int ieee802154_cc13xx_cc26xx_subg_init(const struct device *dev)
{
	...
	drv_data->rf_handle = RF_open(&drv_data->rf_object,
		&rf_mode, (RF_RadioSetup *)&iee802154_cc13xx_radio_div_setup,
		&rf_params);
